    ...
    <div className="max-w-3xl mx-auto px-6 py-16 md:py-20">
      ...
      <div className="prose-invert max-w-none">
        <p className="text-lg text-zinc-300 leading-relaxed mb-6">
          Nathan Renting (officieel: Jonathan David Renting). Solo dev,
          Eindhoven.
        </p>
        ...
        <p className="text-zinc-400 leading-relaxed mb-10">
          ...
          later voor producten en klantwerk. Zelfgeleerd, geen mooi
          LinkedIn-pad. Wat dat oplevert: ik snap audio van binnen en buiten.
          Niet alleen de DSP, ook hoe een producer ergens tegenaan loopt en
          wat een UI moet doen om niet in de weg te zitten. Diezelfde brede
          blik probeer ik in agent-werk te houden: engine, infra en de
        ...
        <p className="text-zinc-400 leading-relaxed mb-4">
          ...
          beloftes als het 4 weken is. Liever vroeg een lelijke versie
          in productie dan een mooie roadmap die nooit gebouwd wordt.
        </p>
